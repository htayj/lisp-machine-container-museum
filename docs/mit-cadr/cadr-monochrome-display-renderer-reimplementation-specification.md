...
timestamp: 2026-07-29T22:25:00-04:00
---
...
| `test_run_cadr_m7_frame_conformance.mjs` | P4 hashes-only manifest schema and substitutions of every release, source, support, artifact, schedule, session, disk, process, native-frame, portable-module, adapter, worker, checkpoint, comparison, and summary binding |
